      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">
            {isLoggedIn
              ? "مرحباً بك في نظام تحويل الصوت لنص"
              : "نظام تحويل الصوت إلى نص"}
          </h1>
                ...
                >
                  ...
                  >
                    <path
                      ...
                      strokeWidth={2}
                      d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-6-6a3 3 0 010-6V5a3 3 0 116 0v1a3 3 0 010 6z"
                    />
                  </svg>
                  ابدأ التحويل الآن
                </button>
